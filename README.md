...
```
> Ответ: `{"status": "ok", "spec_version": "Opus 4.5"}` — удобно для мониторинга и readiness-проб.

### Корневой endpoint
```bash
curl http://localhost:5000/
```
> Ответ содержит краткое описание сервиса, актуальную версию спецификации и ссылку на `USER_GUIDE.md`, что полезно для быстрой проверки доступности API и документации.
